/* ═══════════════════════════════════════════════════════════════
   template-tattoo-001 — Iron Needle Studio — script.js
   creative-bold-dark scroll · single-page · pt-BR
   ═══════════════════════════════════════════════════════════════ */

// ── Scroll animation — frame config ──────────────────────────
var FRAME_PATH   = 'https://8ispuxmgjxgu2r5q.public.blob.vercel-storage.com/templates/tattoo-001/frames/';
...
window.__imgFallback = function (img, label) {
  ...
  var svg = '<svg xmlns="http://www.w3.org/2000/svg" width="' + w + '" height="' + h + '" viewBox="0 0 ' + w + ' ' + h + '">'
    ...
    + '<text x="50%" y="50%" font-family="\'IBM Plex Mono\',monospace" font-size="13" fill="#5C5C5C" text-anchor="middle" dominant-baseline="middle" letter-spacing="0.1em">'
...
var PHOSPHOR_ICONS = {
  ...
  'CurrencyDollar': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="14" stroke-linecap="round" stroke-linejoin="round" width="20" height="20" aria-hidden="true"><line x1="128" y1="24" x2="128" y2="232"/><path d="M88,64 h56 a40,40,0,0,1,0,80 H88 a40,40,0,0,0,0,80 h72"/></svg>',

  'Warning': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="none" stroke="currentColor" stroke-width="14" stroke-linecap="round" stroke-linejoin="round" width="20" height="20" aria-hidden="true"><path d="M236,200 L136,40 a8,8,0,0,0,-16,0 L20,200 a8,8,0,0,0,8,12 H228 a8,8,0,0,0,8,-12 Z"/><line x1="128" y1="104" x2="128" y2="152"/><circle cx="128" cy="180" r="4" fill="currentColor" stroke="none"/></svg>',
...
(function () {
  ...
  // ── Liquid Bubble — track mouse position ─────────────────
  document.querySelectorAll('.cta-liquid').forEach(function (btn) {
  ...
  if ('IntersectionObserver' in window) {
    ...
    // ── Text Reveal observer — solo .text-reveal ──────────
